...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    var listItems = this.state.data.map((function (item, i) {
	      return React.createElement(
	        'li',
	        { 'data-id': i, key: i, draggable: 'true', className: 'drag', onDragEnd: this.dragEnd, onDragStart: this.dragStart },
	        item
	      );
	    }).bind(this));
	    ...
	    var chooseItems = this.state.items.map((function (item, i) {
	      return React.createElement(
	        'li',
	        { 'data-id': i, key: i, onDragOver: this.dragOver, onDragLeave: this.dragLeave },
	        item
	      );
	    }).bind(this));
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'ul',
	        { id: 'dropContainer', onDragOver: this.dragOver, onDrop: this.drop, className: 'container', onDragEnter: this.dragEnter },
	        chooseItems
	      )
	    );
	  },
	...
	ReactDOM.render(React.createElement(Listchoose, { data: data }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./Listchoose.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./Listchoose.less");
